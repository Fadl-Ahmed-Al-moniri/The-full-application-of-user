...
import 'package:bigcart/controller/home/pages/items/typeofAnimls_controller.dart';
...
class TypeofAnimlsPage extends StatelessWidget {
  const TypeofAnimlsPage({super.key});
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
    TypeofanimlsController controller = Get.put(TypeofanimlsController());
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemCount: controller.animlList.length,
            ...
            child: Stack(
              children: [
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: controller.isloding == false
                          ? Image.asset(
                              controller.animlList[index].image!,
                              alignment: Alignment.center,
                              fit: BoxFit.cover,
                            )
                          : Shimmer.fromColors(
                ...
                Positioned(
                    ...
                    right: 2,
                    child:
                        //  controller.animlList[index].isFavorite ==
                        //         true
                        //     ?
                ...
                Positioned(
                  ...
                  child: controller.isloding == false
                      ? Text(
                          controller.animlList[index].name!,
                ...
                Positioned(
                  ...
                  child: controller.isloding == false
                      ? Text(
                          controller.animlList[index].price.toString(),
